...
<header class="site-header">
  <div class="container header-inner">
    <a href="<?= $base ?>index.php" class="brand" aria-label="Esquel LAB — inicio">
      <img src="<?= $base ?>assets/images/web/logo-esquel-lab-horizontal.png" alt="Esquel LAB" class="brand-logo" width="338" height="96">
    </a>
    ...
    <nav class="site-nav" id="siteNav">
      ...
      <a href="<?= $base ?>index.php#que-se-trabaja">Qué se trabaja</a>
      <a href="<?= $base ?>index.php#preguntas">FAQ</a>
      <a href="<?= $base ?>media-kit.php" <?= $activeNav === 'prensa' ? 'class="is-active"' : '' ?>>Media kit</a>
