...
$colsCriterios        comentario TEXT NOT NULL DEFAULT '',
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS lab_estudiantes (
        ...
        movilidad TEXT NOT NULL DEFAULT '',
        dispositivo_trabajo TEXT NOT NULL DEFAULT '',
        interes_fuerte TEXT NOT NULL DEFAULT '',
        interes_debil TEXT NOT NULL DEFAULT '',
        ...
        m_arrancar INTEGER NOT NULL DEFAULT 3,
        m_traba INTEGER NOT NULL DEFAULT 3,
        m_ritmo INTEGER NOT NULL DEFAULT 3,
        m_rendir INTEGER NOT NULL DEFAULT 3,
        m_gente INTEGER NOT NULL DEFAULT 3,
        m_comunicar INTEGER NOT NULL DEFAULT 3,
        m_correccion INTEGER NOT NULL DEFAULT 3,
        m_destino INTEGER NOT NULL DEFAULT 3,
        cp_organizar TEXT NOT NULL DEFAULT '',
        cp_contactar TEXT NOT NULL DEFAULT '',
        cp_inconcluso TEXT NOT NULL DEFAULT '',
        cp_cobrar TEXT NOT NULL DEFAULT '',
        cp_critica TEXT NOT NULL DEFAULT '',
        ...
        r_posicion TEXT NOT NULL DEFAULT '',
        r_producto_json TEXT NOT NULL DEFAULT '{}',
        r_movimientos TEXT NOT NULL DEFAULT '',
        r_cuenta TEXT NOT NULL DEFAULT '',
        r_expectativa TEXT NOT NULL DEFAULT '',
        created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
        FOREIGN KEY (consultor_id) REFERENCES lab_consultores (id) ON DELETE CASCADE,
