...
function lab_asegurar_datos(PDO $pdo): void
{
    ...
    $proyectos = [
            ...
            [
                ...
                'adria',
                'noelia',
                "[\"Iniciativa de excelencia en turismo rural, de naturaleza y bienestar en predio cordillerano sobre Ruta 259 (km 25 / Barrio Los Cóndores), a mitad de camino entre Esquel y Trevelin. Cuenta con bosque centenario de pinos ('El Pinar'), matera histórica alemana, pista de monta y corrales en comodato con Carlos Baroli.\",\"Trayectoria consolidada y solvencia interdisciplinaria: titular bióloga y docente de biología (Colegio Salesiano), cofundadora de la Fundación Patagónica de Equinoterapia (2011). Integra un equipo de salud (psicomotricista, kinesiólogo, psicóloga, docentes especiales y ecuestres) junto al programa comunitario 'Guardianes de Lucero'. Compromiso personal de Leandro Choi (conducción del LAB, padre de un niño con autismo) para asumir personalmente el desarrollo de la plataforma web transaccional.\",\"Propuesta integral cuádruple: 1) Granja Educativa de Rescate (chinchillas, ratas de laboratorio, cerdita minipig Rita Uva, Pamperito de 35 años); 2) Escuela de Monta Consciente y Respetuosa (sin someter al caballo, pie a tierra y rienda suave); 3) Equinoterapia Interdisciplinaria con alta demanda sostenida; y 4) Terapias de Bienestar (yoga, meditación y constelaciones con caballos, coaching y feria El Paseo del Pinar).\"]",
                "[\"Dispersión operativa y falta de paquetización comercial: necesidad de acotar la oferta para el visitante espontáneo a 2 experiencias claras con días fijos (martes, miércoles y sábados) para no interferir con la docencia escolar ni con la equinoterapia de los viernes.\",\"Estacionalidad forrajera invernal y ciclo natural: cierre en invierno por descanso de la manada y alto costo de fardos de alfalfa y avena (sin pastura en el pinar), requiriendo un flujo turístico en temporada que subsidie la sustentabilidad y el recambio de suelo con compost orgánico cada septiembre.\",\"Gestión de reservas y seguros (Patagonia Broker / Mercantil Andina): necesidad de prueba de pista obligatoria previa a la cabalgata para evaluar la mano del jinete y cuidar la boca del caballo, requiriendo un sistema digital que exija antelación para el alta de póliza y evite la subvaloración tarifaria frente al mercado (Frisón Baroque cobra $90.000 vs $20.000-$40.000 de Lucero).\"]",
                "[{\"t\":\"Curaduría de 2 Experiencias Estrella, Seguridad y Seguros\",\"items\":[\"Experiencia 1: 'Granja Educativa & Saberes Vivos' (75 min, familiar y niños, historias de rescate, interacción perimetral sin boyero y merienda en la matera).\",\"Experiencia 2: 'Bautismo Ecuestre & Encuentro con el Caballo' (90 min, vínculo pie a tierra, cepillado, prueba en pista obligatoria para cuidar la boca del animal y paseo en El Pinar).\",\"Protocolo formal de seguridad y gestión de seguros (Patagonia Broker / Mercantil Andina) con recolección previa obligatoria de datos vía web.\"]},{\"t\":\"Plataforma Web Transaccional y Producción Audiovisual 4K\",\"items\":[\"Desarrollo a cargo de Leandro Choi de la plataforma web transaccional con backend para gestión de cupos, días disponibles (mar/mié/sáb), cobro de señas y datos para el alta de seguros.\",\"Producción audiovisual profesional financiada por el LAB (cámaras 4K + dron): 3 cápsulas documentales (historia de arraigo de Sol y su abuelo Toto Arrechea, coaching en El Pinar y Guardianes de Lucero).\"]},{\"t\":\"Estructura de Costos Forrajeros, Tarifario Dual y Alianzas B2B\",\"items\":[\"Planilla paramétrica de costos que amortice el forraje invernal y nuevo tarifario comercial: tarifa general turista vs tarifa social para residentes esquelenses/trevelinenses.\",\"Kit físico infantil 'Pequeño Cuidador / Guardián de Lucero', souvenirs de compost/semillas, alianzas con agencias receptivas de la Comarca y sinergia con Haiku Casa de Té.\"]}]",
                "[\"Fichas técnicas y guiones interpretativos estandarizados de las 2 Experiencias Turísticas ('Granja Educativa' y 'Bautismo Ecuestre').\",\"Protocolo de bioseguridad, deslinde de responsabilidad y circuito de alta previa de seguros Patagonia Broker con prueba en pista obligatoria.\",\"Plataforma web transaccional operativa desarrollada por Leandro Choi con panel de administración de turnos y cupos.\",\"Banco de contenidos audiovisuales 4K con tomas aéreas con dron y 3 cápsulas de video institucionales.\",\"Planilla de costeo paramétrico de forraje invernal y tarifario comercial minorista/mayorista (B2C general y residente / B2B agencias receptivas).\",\"Kit del 'Pequeño Cuidador / Guardián de Lucero' prototipado (libreta de campo, pin de madera y pack de semillas/compost) y acuerdos con agencias.\"]"
            ],
            [
                'sabor',
                7,
    ...
    if ($countReu === 0) {
        ...
        $reuniones = [
            ...
            [
                ...
                'lucero',
                1,
                "Diagnóstico integral en predio, relevamiento de corrales, compost y El Pinar",
                'ter',
                ...
                "12:30",
                'programada',
                "Visitar el predio en Ruta 259 km 25. Relevar el circuito de corrales de la granja educativa (chinchillas, ratas de laboratorio, cerdita Rita Uva, Pamperito de 35 años), la pista de monta, el recambio de suelo con compost orgánico de septiembre y la matera histórica alemana. Evaluar accesibilidad y capacidad de carga.",
                "[\"¿Qué capacidad de carga simultánea tienen los corrales para no estresar a los animales de rescate?\",\"¿Cómo organizamos los horarios turísticos (martes, miércoles y sábados) para no interferir con la docencia escolar de Sol ni con la equinoterapia de los viernes?\",\"¿Qué mejoras de señalética y senderos en El Pinar se requieren antes del inicio de temporada?\"]",
                "[\"Mapear el circuito físico de la visita a la granja y el sendero ecuestre por El Pinar.\",\"Relevar el ciclo de compostaje y mantenimiento de corrales para la experiencia pedagógica.\",\"Definir el cronograma semanal de atención: martes, miércoles y sábados de 10:00 a 17:00.\"]",
                "[{\"id\":1,\"texto\":\"Inspeccionar corrales, pista de monta, boyero perimetral y matera histórica\",\"done\":false},{\"id\":2,\"texto\":\"Diseñar el plano de zonificación: granja perimetral, pista de prueba y bosque El Pinar\",\"done\":false},{\"id\":3,\"texto\":\"Fijar los días y horarios fijos semanales para visitas turísticas regulares\",\"done\":false}]",
                ["adria","noelia"]
            ],
            [
                'lucero-02',
                'lucero',
                2,
                "Estandarización de 2 Experiencias, Prueba en Pista y Seguros Patagonia Broker",
                'ter',
                ...
                "12:30",
                'programada',
                "Cerrar la ficha técnica y guion de las 2 experiencias turísticas: 1) Granja Educativa & Saberes Vivos (75 min, sin contacto con boyero, historias de rescate y mateada) y 2) Bautismo Ecuestre & Encuentro con el Caballo (90 min, vínculo pie a tierra, cepillado, prueba en pista para evaluar la mano del jinete y paseo en El Pinar). Protocolizar el alta previa obligatoria de seguros con Patagonia Broker / Mercantil Andina.",
                ...
                "[\"Redactar el guion didáctico paso a paso de la visita a la granja y el bautismo ecuestre.\",\"Formalizar el protocolo de prueba en pista obligatoria para resguardar el bienestar del animal.\",\"Estructurar el formulario digital de recolección de datos personales y médicos para el seguro.\"]",
                "[{\"id\":1,\"texto\":\"Aprobar el guion interpretativo de las 2 experiencias turísticas\",\"done\":false},{\"id\":2,\"texto\":\"Redactar el protocolo de prueba en pista y deslinde de responsabilidad civil\",\"done\":false},{\"id\":3,\"texto\":\"Validar el circuito administrativo de pólizas con Patagonia Broker / Mercantil Andina\",\"done\":false}]",
                ["adria","noelia"]
            ],
            [
                'lucero-03',
                'lucero',
                3,
                "Estructura de costos forrajeros, amortización invernal y tarifario dual B2C/B2B",
                'ind',
                "LAB Esquel / Secretaría de Turismo",
                '2026-10-03',
                "10:30",
                "12:30",
                'programada',
                "Construir la planilla de costeo paramétrico. Desglosar forraje invernal (fardos de alfalfa y avena indispensables por falta de pasto en el pinar), veterinario, seguros y mantenimiento. Analizar el benchmark de mercado (Frisón Baroque $90.000 vs tarifas de Sol de $20.000/$40.000). Establecer un esquema tarifario dual: tarifa general para turistas y tarifa social para residentes de Esquel y Trevelin, más comisión del 20-25% para agencias EVyT.",
                "[\"¿Cuánto forraje comercial se consume durante los meses de cierre invernal y cómo se amortiza con la temporada estival?\",\"¿Cuál es el precio justo de mercado para reposicionar a Lucero sin perder accesibilidad?\",\"¿Qué porcentaje de comisión se asigna a las agencias receptivas de Esquel y Trevelin?\"]",
                "[\"Parametrizar el costo unitario de manutención de la manada y punto de equilibrio.\",\"Emitir la lista oficial de precios: tarifa turista general, tarifa social residente y tarifa mayorista B2B.\",\"Definir la política de reservas (50% de seña para congelar turno) y cancelaciones por mal tiempo.\"]",
                "[{\"id\":1,\"texto\":\"Cargar la planilla de costos forrajeros y amortización anual en Drive/Excel\",\"done\":false},{\"id\":2,\"texto\":\"Emitir la ficha tarifaria comercial dual (turista / residente / agencias)\",\"done\":false},{\"id\":3,\"texto\":\"Fijar el porcentaje de seña anticipada y protocolo de reprogramación climática\",\"done\":false}]",
                ["adria","noelia"]
            ],
            [
                'lucero-04',
                'lucero',
                4,
                "Desarrollo del Kit Pequeño Cuidador, Cuadernos de Historias y Merchandising",
                'ind',
                "Centro Ecuestre Lucero",
                '2026-10-10',
                "10:30",
                ...
                "[\"¿Qué relatos del abuelo Toto y de los animales rescatados generan mayor conexión emocional y pedagógica con los chicos?\",\"¿Qué costo unitario de imprenta permite ofrecer el kit a un precio accesible y rentable?\",\"¿Cómo se ambientará el rincón de recepción y venta artesanal junto a la matera histórica?\"]",
                "[\"Cerrar el diseño gráfico y pedagógico del Kit del Pequeño Cuidador.\",\"Cotizar una primera tirada de 100 cuadernillos y 100 pins con proveedores comarcales.\",\"Diseñar el packaging sustentable de los sobres de compost de septiembre y semillas.\"]",
                "[{\"id\":1,\"texto\":\"Aprobar el boceto de la libreta de actividades del Pequeño Cuidador\",\"done\":false},{\"id\":2,\"texto\":\"Diseñar los stickers y empaques de compost orgánico y semillas de granja\",\"done\":false},{\"id\":3,\"texto\":\"Definir el precio de venta del kit y de los recuerdos en la matera histórica\",\"done\":false}]",
                ["adria","noelia"]
            ],
            [
                'lucero-05',
                'lucero',
                5,
                "Producción audiovisual 4K con dron y arquitectura de la plataforma web",
                'ter',
                "Centro Ecuestre Lucero",
                '2026-10-17',
                "10:00",
                "13:00",
                'programada',
                "Jornada de producción audiovisual profesional financiada por el LAB (cámaras 4K y dron en El Pinar) para rodar 3 cápsulas: 1) Raíces e Historia familiar (Sol Arrechea y el legado de Toto); 2) Bienestar y Conexión en El Pinar (tomas aéreas del bosque y monta consciente); y 3) Guardianes de Lucero (niños y animales de rescate). En paralelo, revisión técnica con Leandro Choi de la arquitectura de la plataforma web transaccional para reservas y seguros.",
                "[\"¿Cuáles son las locaciones y ángulos aéreos más impactantes de El Pinar y los corrales para el vuelo del dron?\",\"¿Cómo estructurar la carga de datos del visitante en la web para automatizar la planilla de seguros antes de su llegada?\",\"¿Qué pasarela de pagos (Mercado Pago / transferencia) dejamos integrada para cobrar las señas?\"]",
                "[\"Rodar el material audiovisual 4K y tomas con dron para las 3 cápsulas promocionales.\",\"Validar la interfaz de reservas online: selección de días (mar/mié/sáb), turnos, cupos y formulario médico.\",\"Generar un banco fotográfico de alta resolución para la web y redes sociales.\"]",
                "[{\"id\":1,\"texto\":\"Completar el plan de rodaje con cámaras 4K y tomas aéreas de dron\",\"done\":false},{\"id\":2,\"texto\":\"Aprobar el wireframe funcional de la plataforma web transaccional diseñada por Leandro\",\"done\":false},{\"id\":3,\"texto\":\"Seleccionar las tomas fotográficas para el catálogo digital y encabezados web\",\"done\":false}]",
                ["adria","noelia","leandro"]
            ],
            [
                'lucero-06',
                'lucero',
                6,
                "Rueda comercial B2B con agencias de Esquel/Trevelin y sinergia con Haiku",
                'ind',
                "Oficinas de Turismo / Centro Cultural Melipal",
                '2026-10-24',
                "10:30",
                ...
                "[\"¿Qué interés manifiestan las agencias de Esquel y Trevelin en sumar una parada rural/ecuestre camino al Valle de los Tulipanes y Molino Nant Fach?\",\"¿Cómo coordinamos con Haiku la provisión de blends de té y vajilla para retiros en el bosque?\",\"¿Qué cronograma establecemos para la próxima edición de El Paseo del Pinar en primavera?\"]",
                "[\"Presentar el catálogo oficial a 3 agencias receptivas habilitadas de la Comarca.\",\"Firmar al menos 2 convenios de comercialización y derivación turística con agencias locales.\",\"Acordar la realización de una experiencia piloto combinada Lucero + Haiku Casa de Té.\"]",
                "[{\"id\":1,\"texto\":\"Reunión comercial con agencias receptivas seleccionadas con catálogo en mano\",\"done\":false},{\"id\":2,\"texto\":\"Firmar acuerdos de comercialización turística con tarifario mayorista\",\"done\":false},{\"id\":3,\"texto\":\"Diseñar la propuesta del retiro holístico combinado en El Pinar con Haiku\",\"done\":false}]",
                ["adria","noelia"]
            ],
            [
                'lucero-07',
                'lucero',
                7,
                "Fam Tour en terreno con informantes turísticos y test de la plataforma web",
                'ter',
                "Centro Ecuestre Lucero",
                '2026-10-31',
                "10:30",
                "13:00",
                'programada',
                "Simulacro vivencial en campo con un grupo de prueba (informantes de Turismo de Esquel y Trevelin, guías y prestadores de la cohorte). Prueba en vivo del sistema de reservas web: registro previo de participantes y alta de seguros. Recorrido guiado completo por corrales, bautismo ecuestre con prueba de pista, entrega del Kit del Pequeño Cuidador y merienda campesina en la matera histórica.",
                "[\"¿El proceso de reserva web y carga previa de datos para el seguro resultó ágil y claro para el usuario?\",\"¿Cómo valoraron los informantes turísticos la calidez del relato y el bienestar visible de los animales?\",\"¿Qué ajustes finales sugieren en cuanto a tiempos de recorrido y cartelería informativa?\"]",
                "[\"Validar el funcionamiento operativo de la plataforma web y el alta de seguros en un caso real.\",\"Cronometrar los tiempos de las experiencias para asegurar puntualidad entre turnos.\",\"Recoger devoluciones técnicas de los informantes turísticos para su recomendación en mostrador.\"]",
                "[{\"id\":1,\"texto\":\"Ejecutar el Fam Tour con 10 informantes y prestadores invitados\",\"done\":false},{\"id\":2,\"texto\":\"Comprobar el circuito digital de reserva, confirmación y alta de póliza\",\"done\":false},{\"id\":3,\"texto\":\"Completar encuestas de satisfacción sobre seguridad, hospitalidad y contenido didáctico\",\"done\":false}]",
                ["adria","noelia","leandro"]
            ],
            [
                'lucero-08',
                'lucero',
                8,
                "Ronda de negocios final, lanzamiento de plataforma web y pitch institucional",
                'col',
                "Centro Cultural Melipal / Espacio LAB",
                '2026-11-07',
                "09:30",
                "13:00",
                'programada',
                "Participación protagónica en el Encuentro de Cierre de Esquel LAB. Montaje de mesa temática de Centro Ecuestre Lucero con exhibición de los kits de Pequeño Cuidador, frascos de compost orgánico, fotos de El Pinar y terminal interactiva con la plataforma web desarrollada por Leandro Choi. Pitch de 3 minutos de Sol Arrechea presentando Lucero: Bienestar, Arraigo Familiar y Conexión con la Manada. Firma de acuerdos comerciales y entrega de la hoja de ruta post-LAB.",
                "[\"¿Cuáles son los resultados de reservas generadas durante los primeros días de la plataforma web?\",\"¿Cómo queda planificado el balance operativo de Sol para la temporada alta de verano 2026/2027?\",\"¿Qué pasos inmediatos se proyectan para la postulación a líneas de financiamiento municipal y provincial?\"]",
                "[\"Presentar públicamente la plataforma web transaccional y las cápsulas audiovisuales 4K.\",\"Consolidar acuerdos comerciales firmes con agencias receptivas y alojamientos de la Comarca.\",\"Entregar el plan operativo de consultoría post-incubación y cronograma de temporada alta.\"]",
                "[{\"id\":1,\"texto\":\"Montar el stand interactivo con material de granja, kits infantiles y navegación web\",\"done\":false},{\"id\":2,\"texto\":\"Exponer el pitch de 3 minutos ante autoridades municipales, prestadores y medios\",\"done\":false},{\"id\":3,\"texto\":\"Firmar acuerdos de comercialización formal y entrega de la hoja de ruta 2026/2027\",\"done\":false}]",
                ["adria","noelia","leandro"]
            ],
            [
                'sabor-01',
